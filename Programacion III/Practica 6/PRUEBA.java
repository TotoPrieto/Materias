public class PRUEBA {
  ...
  public static void main(String[] args) {
    ...
    //		Tokyo ---------------- Berlin -------------  Toronto
                ...
                grafo.conectar(buenosAires, madrid,0);
                grafo.conectar(buenosAires, rio,0);
                grafo.conectar(madrid, berlin,0);
                grafo.conectar(choele, laPlata,0);
                grafo.conectar(choele, seoul,0);
                grafo.conectar(choele, beijing,0);
                grafo.conectar(tokyo, berlin,0);
                grafo.conectar(sydney, choele,0);
                grafo.conectar(newYork, london,0);
                grafo.conectar(newYork, mexicoCity,0);
                grafo.conectar(jacobacci, rome,0);
                grafo.conectar(jacobacci, dubai,0);
                grafo.conectar(jacobacci, madrid,0);
                grafo.conectar(berlin, toronto,0);
                grafo.conectar(dubai, jacobacci,0);
                grafo.conectar(dubai, tokyo,0);
                grafo.conectar(london, paris,0);
                grafo.conectar(london, beijing,0);
                grafo.conectar(london, newYork,0);
                grafo.conectar(paris, toronto,0);
                grafo.conectar(paris, london,0);
                grafo.conectar(toronto, paris,0);
                grafo.conectar(mexicoCity, rio,0);
                grafo.conectar(mexicoCity, newYork,0);
                grafo.conectar(rio, sydney,0);
                grafo.conectar(rio, mexicoCity,0);
                grafo.conectar(beijing, choele,0);
                grafo.conectar(beijing, london,0);
                grafo.conectar(seoul, berlin,0);
                
                ListaGenerica<String> lis = new ListaGenericaEnlazada<String>();
              //  lis.agregarFinal("Madrid");
                lis.agregarFinal("London");
    
    
              Mapa m= new Mapa(grafo);
              System.out.println("Devolver camino New York-Paris:  "+ m.devolverCamino("New York", "Paris"));
              System.out.println("Devolver camino New York-Paris Exceptuando London:  "+ m.devolverCaminoExceptuando("New York", "Paris", lis));
              System.out.println("Devolver camino mas corto de New York-Paris:  "+ m.caminoMasCorto("New York", "Paris"));
              System.out.println("Devolver camino New York-Paris:  "+ m.caminoSinCargarCombustible("New York", "Paris",300));
